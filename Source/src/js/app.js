App = {
    ...
    getMetaskAccountID: function () {
        ...
        web3.eth.getAccounts(function(err, res) {
            ...
            App.contractOwner=web3.eth.accounts[0];
    ...
    processItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.processItem($("#upc").val(), {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
            App.fetchItemBufferTwo(event);
    ...
    packItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.packItem($("#upc").val(), {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
            App.fetchItemBufferTwo(event);
    ...
    sellItem: function (event) {
        ...
        //var processId = parseInt($(event.target).data('id'));
        App.upc = $('#upc').val();  
        App.productPrice = web3.toWei(1, "ether");
        App.contracts.SupplyChain.deployed().then(function(instance) {           
    ...
    ///    var processId = parseInt($(event.target).data('id'));
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
          return instance.fetchItemBufferTwo.call(App.upc);
            ...
            $("#productPrice").val(result[4]/1000000000000000000);
            $("#itemState").text(App.getItemState(result[5].toNumber()));
